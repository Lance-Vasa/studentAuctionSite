...
const auction_scheduler_service_1 = require("./auction-scheduler.service");
...
exports.ListingsModule = ListingsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [listings_service_1.ListingsService, auction_scheduler_service_1.AuctionSchedulerService],
